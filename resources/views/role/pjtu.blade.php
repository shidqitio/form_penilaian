	...
	<div class="row" id="body-row">
		<div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
			<ul class="list-group">
				...
				<a href="" data-toggle="modal" data-target="#download1" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
				...
				<a href="" data-toggle="modal" data-target="#download" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-start align-items-center">
						<span class="nav-icon fas fa-copy mr-3"></span>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								@endforeach
								@foreach($uas as $uas)
								<h5>Download Panduan UAS dari Wakil Rektor 3</h5>
								<a href="/download/uas/{{ $uas->id }}" class="btn btn-success">Download</a>
								@endforeach
