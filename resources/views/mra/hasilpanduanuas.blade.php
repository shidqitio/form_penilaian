@extends('upbjjfront.master_upbjj3')
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <form class="form-inline" method="get" action="/upbjj/searchpanduanuas">
                        {{ csrf_field() }}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/download/uas/{{ $i->id }}" class="btn btn-success">Download</a>
