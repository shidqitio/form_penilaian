...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/tambahmasa" enctype="multipart/form-data">
                            {{ csrf_field() }}
        ...
        <!-- Modal For Delete -->
        <div class="modal fade" id="hapus_{{$masa->kd_masa}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        Hapus Data - {{$masa -> tahun_masa}}
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
                        <a id="delete-btn" href="/masa/hapus/ {{$masa->kd_masa}}" class="btn btn-danger">Iya</a>
                    </div>
                </div>
            </div>
        </div>
