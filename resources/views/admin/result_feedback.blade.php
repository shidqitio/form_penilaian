        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <form class="form-inline" method="get" action="{{route('searchfeedbackadmin')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="submit" class="btn btn-success  mr-5" name="ExportExcel"> Cetak Laporan
                            </button>
                        ...
                        <table class="mb-0 table table-bordered table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $i->lokasi_ujian }}</td>
                                    <td>{{ $i->bertugas_sebagai }}</td>
                                    <td>{{ $i->upbjj }}</td>
                                    <td>{{ $i->masa_ujian }}</td>
                                    <td>{{ $i->tanggal_mulai_observasi }}</td>
                                    <td>{{ $i->tanggal_akhir_observasi }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
