    ...
    <div class="app-main__inner">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h5>1. Apakah setiap panitia ujian di lokasi ujian menerima SK Panitia Ujian? (PJTU, PJLU,
                            Pengawas Keliling, Pengawas Ruang, Tenaga administrasi) </h5>
                        <div id="app" style="width: 150 px; height: 150px ;">
                            {!! $charts10->container() !!}
                        </div>
                    </div>
                ...
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h5>2. Apakah Denah Lokasi Ujian, Tata Tertib, Nomor Ruang, dan Daftar Peserta Ujian ditempel
                            sesuai ketentuan?* </h5>
                        <div id="app" style="width: 150 px; height: 150px ;">
                            {!! $charts15->container() !!}
                        </div>
                ...
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h5>4. Apakah terdapat lokasi ujian yang menggunakan aula atau GOR? Jika ya, lanjutkan ke
                            pertanyaan 5. Jika tidak lanjutkan ke pertanyaan 6* </h5>
                        <div id="app" style="width: 150 px; height: 150px ;">
                            {!! $charts17->container() !!}
                        </div>
                    </div>
                ...
                <div class="jumbotron jumbotron-fluid table-wrapper-scroll-y my-custom-scrollbar">
                    <div class="container">
                        <h5>Bila iya, tuliskan jenis pelanggaran yang ditemukan (informasi lengkap pelanggaran mencakup
                            nama, NIM, ruang ujian, lokasi ujian, kode dan nama matakuliah serta foto dikirimkan ke
                            timbul@ecampus.ut.ac.id menggunakan format lampiran yang ada di panduan pedoman UAS) </h5>
                        <ul class="list-group ">
                            @foreach($pemantau as $form)
                ...
                <div class="jumbotron jumbotron-fluid table-wrapper-scroll-y my-custom-scrollbar">
                    <div class="container">
                        <h5>Bila tidak, tuliskan secara detail nama pengawas, jam ujian, nomor ruang, lokasi ujian:
                        </h5>
                        <ul class="list-group ">
                            @foreach($pemantau as $form)
                ...
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h5>13. Apakah permintaan naskah ujian tambahan dan penggandaan naskah ujian sesuai dengan
                            ketentuan?* </h5>
                        <div id="app" style="width: 150 px; height: 150px ;">
                            {!! $charts26->container() !!}
                        </div>
